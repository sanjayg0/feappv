...
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      ...
      real*8    dv, dv1,dv2, pen,ggi,ggv,tc, xsj, thk
      ...
      real*8    dvl(9),eps(6),sig(6)
      real*8    yl(3,4),vl(6,4,3),tr(3,3),bl(3),bg(3)
      real*8    gshp1(3,4),gshp2(3,4),gg(6,4),dd(6,6,5)
      real*8    bmat(4,6,4), dbmat(6,4)
...
2003  format(/i5,0p,1f8.3,1p,5e11.3,0p,1f8.2/i5,0p,1f8.3,1p,5e11.3,
     ...
     &                   ndf,nel,numnp,isw)
      ...
      real*8    dt(numnp),st(numnp,*),yl(3,*),tr(3,3),d(*),ul(ndf,*)
      real*8    vl(6,4),dvl(4)
      real*8    eps(6),sig(6),momt(6),norm(6),dd(6,6,5),eps0(6)
...
!     Compute membrane and bending stresses for projection.
     ...
     &                  nn,isw)
      ...
      real*8    xx,yy,zz, hh, ta, alam, ha

      real*8    d(*), xl(ndm,*),vl(6,*), eps0(6),eps(6),sig(6)
      real*8    dd(6,6,5)

      save

      data      alam, ha / 0.0d0, 0.0d0 /
...
!- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      ...
      real*8    d(*),xl(ndm,*),ul(ndf,nen,*),s(nst,*),r(ndf,*)
      real*8    norm(6),dvl(9),momt(6),eps(6)
      real*8    yl(3,4),vl(6,4,3),tr(3,3),bl(3),bg(3)
      real*8    btd(3,6),gshp1(3,4),gshp2(3,4),gg(24),dd(6,6)
!     real*8    b0(4,2,4),bf(4,3,4), ddb0(4,2), ddbf(4,3)
